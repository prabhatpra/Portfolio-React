// src/components/Project/AddProjectForm.jsx
  ...
  return (
    <div className="fixed inset-0 bg-black/50 flex justify-center items-center z-50">
      ...
      >
        ...
        {["title","description","image","tech","liveLink","githubLink"].map((field) => (
          <input
            key={field}
            type="text"
            name={field}
            placeholder={field.charAt(0).toUpperCase() + field.slice(1).replace("Link"," Link")}
